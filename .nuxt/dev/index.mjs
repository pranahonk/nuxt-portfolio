globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Volumes/TEAM%20SSD/WebstormProjects/nuxt-portfolio/node_modules/node-fetch-native/dist/polyfill.mjs';
...
import { renderToString } from 'file:///Volumes/TEAM%20SSD/WebstormProjects/nuxt-portfolio/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Volumes/TEAM%20SSD/WebstormProjects/nuxt-portfolio/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Volumes/TEAM%20SSD/WebstormProjects/nuxt-portfolio/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Volumes/TEAM%20SSD/WebstormProjects/nuxt-portfolio/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Volumes/TEAM%20SSD/WebstormProjects/nuxt-portfolio/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Volumes/TEAM%20SSD/WebstormProjects/nuxt-portfolio/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Volumes/TEAM%20SSD/WebstormProjects/nuxt-portfolio/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Volumes/TEAM%20SSD/WebstormProjects/nuxt-portfolio/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Volumes/TEAM%20SSD/WebstormProjects/nuxt-portfolio/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Volumes/TEAM%20SSD/WebstormProjects/nuxt-portfolio/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Volumes/TEAM%20SSD/WebstormProjects/nuxt-portfolio/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Volumes/TEAM%20SSD/WebstormProjects/nuxt-portfolio/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Volumes/TEAM%20SSD/WebstormProjects/nuxt-portfolio/node_modules/radix3/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "baseURL": "https://prana-wijaya.netlify.app/",
    "githubUsername": "pranahonk",
    "notionTableId": "f906db55071f471eb418879a2d0b3c7f",
    "notionAboutPageId": "34f33e041bc74cea89530902deef0012",
    "notionPortfolioPageId": "316c052484be4a62b8c39bb5dcd36c01",
    "devName": "Prana Apsara Wijaya",
    "devDescription": "a passionate Javascript developer from Indonesia who loves to build and deliver quality products.",
...
const serverAssets = [{"baseName":"server","dir":"/Volumes/TEAM SSD/WebstormProjects/nuxt-portfolio/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Volumes/TEAM SSD/WebstormProjects/nuxt-portfolio","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Volumes/TEAM SSD/WebstormProjects/nuxt-portfolio/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Volumes/TEAM SSD/WebstormProjects/nuxt-portfolio/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Volumes/TEAM SSD/WebstormProjects/nuxt-portfolio/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _Me8T7ML7KC = (function(nitro) {
...
const _uFQbgS = defineEventHandler((event) => {
  event.res.setHeader("Cache-Control", "s-maxage=120, stale-while-revalidate");
});

const _lazy_wYlX7L = () => Promise.resolve().then(function () { return _pageId_$1; });
const _lazy_lLzfXP = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _uFQbgS, lazy: false, middleware: true, method: undefined },
  { route: '/api/page/:pageId', handler: _lazy_wYlX7L, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_lLzfXP, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_lLzfXP, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Volumes/TEAM SSD/WebstormProjects/nuxt-portfolio/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Volumes/TEAM SSD/WebstormProjects/nuxt-portfolio/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
