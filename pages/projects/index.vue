          ...
          <div class="p-6">
            ...
            <div class="flex gap-3 mb-4">
              <a
                ...
                class="relative z-10 flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-purple-600 transition-colors"
                @click.stop
              >
            ...
            <!-- View Details Button -->
            <span class="w-full inline-block text-center px-4 py-2 bg-purple-600 group-hover:bg-purple-700 text-white font-medium rounded-lg transition-colors">
              View Details
            </span>
          </div>
        </NuxtLink>
